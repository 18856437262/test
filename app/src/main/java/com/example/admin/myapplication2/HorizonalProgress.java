...
/**
 * Created by liuchengyuan on 2018/1/10.
 */
...
//    private int colorSecondProgress = Color.argb(255,229,237,245);//背景圆颜色，进度条背景色
    private int colorSecondProgress = Color.argb(255,240,240,240);//背景圆颜色，进度条背景色
    ...
    private int maxProgress = 100; //进度最大值
    ...
    private  void drawProgress(Canvas canvas){
        ...
        rectF.right = curProgress * viewWidth / maxProgress;
        int colorStart = 0xFF46BBFF;
        int colorEnd = 0xFF3D92FF;
